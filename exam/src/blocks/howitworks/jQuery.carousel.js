(function($, undefined) {
  ...
  $.fn.carousel = function(options) {
    ...
    var $container = this;
    var $buttonLeft = $container.children('.crsl__arrow-left');
    var $buttonRight = $container.children('.crsl__arrow-right');
    ...
    var $carouselList = $carouselHider.children('.crsl__list');
    ...
    var $leftArrow = $('.crsl__arrow-left');
    var $rightArrow = $('.crsl__arrow-right');
